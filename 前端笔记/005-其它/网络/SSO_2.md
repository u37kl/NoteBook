...
[Solution ](https://ken.io/category/solution)[Arch ](https://ken.io/category/arch)@ 2017-11-25 15:32:53 · 阅读：（20607）
...
![单点登录（SSO）设计](media/SSO_2/sso-system.png-kblb.png)
...
![SSO系统设计-登录时序图](media/SSO_2/sso-login-sequence.png-kbrb.png)
...
![SSO系统设计-登录信息获取/登录状态校验](media/SSO_2/sso-logincheck-sequence.png-kbrb.png)
...
![SSO系统设计-用户登出](media/SSO_2/sso-logout-sequence.png-kbrb.png)
...
![SSO系统设计-跨域登录（主域名已登录）](media/SSO_2/sso-crossdomain-login-loggedin-sequence.png-kbrb.png)

- 跨域登录（主域名未登录）

![SSO系统设计-跨域登录（主域名未登录）](media/SSO_2/sso-crossdomain-login-unlogin-sequence.png-kbrb.png)

- 跨域登出

![SSO系统设计-跨域登出](media/SSO_2/sso-crossdomain-logout-sequence.png-kbrb.png)
